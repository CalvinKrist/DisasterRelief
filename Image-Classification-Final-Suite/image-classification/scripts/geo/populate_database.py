...
def load_cities(cursor):
    ...
    with open(geodict_config.source_folder+'worldcitiespop.csv') as csv_file:
        ...
        for row in reader:
            ...
            last_word, index, skipped = pull_word_from_end(
                city, len(city)-1, False)
...
def load_countries(cursor):
    ...
    with open(geodict_config.source_folder+'countrypositions.csv') as csv_file:
        file_str = csv_file.read()
        reader = csv.reader(file_str)
    ...
    with open(geodict_config.source_folder+'countrynames.csv') as csv_file:
        file_str = csv_file.read()
        reader = csv.reader(file_str)
        ...
        for row in reader:
            ...
            if country_code:
                ...
                for country_name in country_names_list:
                    ...
                    last_word, index, skipped = pull_word_from_end(
                        country_name, len(country_name)-1, False)
...
def load_regions(cursor):
    ...
    with open(geodict_config.source_folder+'us_statepositions.csv') as csv_file:
        file_str = csv_file.read()
        reader = csv.reader(file_str)
        us_state_positions = {}
    ...
    with open(geodict_config.source_folder+'us_statenames.csv') as csv_file:
        file_str = csv_file.read()
        reader = csv.reader(file_str)
        ...
        for row in reader:
            ...
            for state_name in state_names_list:
                ...
                last_word, index, skipped = pull_word_from_end(
                    state_name, len(state_name)-1, False)
